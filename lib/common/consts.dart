...
const appSupportedLocales = [
  ...
  // TODO(l10n::eu): remove kDebugMode below after translation
  ...
  // TODO(l10n::nl): remove kDebugMode below after translation
  if (kDebugMode) Locale.fromSubtags(languageCode: 'nl'),
