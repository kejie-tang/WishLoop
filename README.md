...
<p align="center"><strong>让喜欢的事，慢慢成为生活的一部分。</strong></p>
...
有没有一件你很感兴趣，却总是没能坚持下去的事？也许是跑步、阅读、学英语，或是用 Vibe Coding 做出自己的小作品。

WishLoop 的初衷是帮助你培养兴趣，并为喜欢的事持续留出时间。你可以为自己的坚持约定一份奖励，用简单的记录和看得见的进度，给下一次投入多一点鼓励。

**选择兴趣 → 持续投入 → 记录坚持 → 奖励自己 → 继续探索**

兴趣本身的乐趣、学到的东西和逐渐积累的能力，才是这段过程里最值得珍惜的收获。奖励是你为这份坚持准备的一点心意。
...
<p align="center">
  ...
  <a href="docs/screenshots/wallet.png"><img src="docs/screenshots/wallet.png" width="260" alt="账户页面：余额与最近 14、30、180 天变化曲线"></a>
</p>
...
先选择想培养的兴趣，再设定适合自己的频率和时长。如果一点奖励能帮助你更容易开始、继续坚持，就为每次投入记下一笔虚拟奖励金。规则由你自己决定，例如：
...
你可以为一段时间的坚持约定一个奖励：一本想读的书、一件兴趣相关的装备，或一次喜欢的体验。愿望清单用来记下这份约定；达到目标时，给自己一份奖励，也回看这段时间为兴趣付出的努力。

还没想好奖励也没关系，可以先开始记录兴趣，等有了合适的想法再添加愿望。
...
2. **选择想培养的兴趣。** 添加两三个自己喜欢的活动，设定频率和时长，从容易做到的一小步开始。
3. **为坚持设定奖励。** 设置每次记录的虚拟奖励金；如果有想送给自己的奖励，再把它加入愿望清单，填写目标金额并设为主要愿望。
4. **从今天的一次投入开始。** 花一点时间做喜欢的事，完成后在“今天”记录，让兴趣逐渐融入日常；需要时从日历补记或撤销。
