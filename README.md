...
[下载 Android APK（v1.1.5）](https://github.com/kejie-tang/WishLoop/releases/tag/v1.1.5) · [v1.1.5 验证记录](docs/wishloop/V1.1.5.md)

## 使用

- **今天**：周/月净奖励日历、账户余额、主要愿望进度与预计天数；点日期补记或撤销。日历下滑展开月视图、标题处上滑收起为周视图，左右滑动翻周/月，也可使用按钮。在最新周/月继续向下一期翻页时，切换周/月视图并保留所选日期；右侧按钮也可切换。
...
[构建环境记录](docs/wishloop/BUILD.md) · [基线结果](docs/wishloop/BASELINE.md) · [最新验证记录](docs/wishloop/V1.1.5.md) · [v1.0.0 验证](docs/wishloop/VERIFICATION.md)
